...
TIMEZONE_OFFSET = -3            # UTC-3 para hora local
REBOOT_INTERVAL_DAYS = 3        # Reinicio cada 3 días
REBOOT_WINDOW_START_HOUR = 3    # Ventana de reinicio: 3 AM
REBOOT_WINDOW_END_HOUR = 5      # Ventana de reinicio: 5 AM
